    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white dark:from-gray-900 dark:to-gray-800 transition-colors">
      <div className="max-w-4xl mx-auto px-4 py-8">
        <div className="mb-8">
          ...
          <h1 className="text-4xl font-bold text-gray-900 dark:text-gray-100 mb-4">Política de Privacidade</h1>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-8 space-y-8">
          <section>
            <h2 className="text-2xl font-semibold text-gray-800 dark:text-gray-200 mb-4">1. Introdução</h2>
          ...
          <section>
            <h2 className="text-2xl font-semibold text-gray-800 dark:text-gray-200 mb-4">2. Política de Não Coleta de Dados</h2>
            <div className="space-y-4">
              <div>
                <h3 className="font-semibold text-gray-800 dark:text-gray-200 mb-2">2.1 Dados de Utilizadores</h3>
                <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
              ...
              <div>
                <h3 className="font-semibold text-gray-800 dark:text-gray-200 mb-2">2.2 Dados Técnicos</h3>
                <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
          ...
          <section>
            <h2 className="text-2xl font-semibold text-gray-800 dark:text-gray-200 mb-4">3. Função de Intermediação</h2>
          ...
          <section>
            ...
            <div className="space-y-4">
              <div>
                <h3 className="font-semibold text-gray-800 dark:text-gray-200 mb-2">4.1 Informações Públicas</h3>
                <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
              ...
              <div>
                <h3 className="font-semibold text-gray-800 dark:text-gray-200 mb-2">4.2 Responsabilidade Própria</h3>
                <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
          ...
          <section>
            <h2 className="text-2xl font-semibold text-gray-800 dark:text-gray-200 mb-4">5. Limitações de Responsabilidade</h2>
            <p className="text-gray-600 dark:text-gray-300 leading-relaxed mb-4">
          ...
          <section>
            <h2 className="text-2xl font-semibold text-gray-800 dark:text-gray-200 mb-4">6. Os Seus Direitos</h2>
            <p className="text-gray-600 dark:text-gray-300 leading-relaxed mb-4">
          ...
          <section>
            <h2 className="text-2xl font-semibold text-gray-800 dark:text-gray-200 mb-4">7. Armazenamento Temporário e Perda de Dados</h2>
            <div className="bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 p-4 rounded-lg mb-4">
              <p className="text-red-800 dark:text-red-200 font-semibold mb-2">AVISO CRÍTICO SOBRE DADOS:</p>
            ...
            <div className="space-y-4">
              <div>
                <h3 className="font-semibold text-gray-800 dark:text-gray-200 mb-2">7.1 Natureza Temporária dos Dados</h3>
                <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
              ...
              <div>
                <h3 className="font-semibold text-gray-800 dark:text-gray-200 mb-2">7.2 Backup e Recuperação</h3>
                <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
          ...
          <section>
            <h2 className="text-2xl font-semibold text-gray-800 dark:text-gray-200 mb-4">8. Plataformas Terceiras e Processamento de Dados</h2>
            <p className="text-gray-600 dark:text-gray-300 leading-relaxed mb-4">
            ...
            <div className="space-y-4">
              <div>
                <h3 className="font-semibold text-gray-800 dark:text-gray-200 mb-2">8.1 Replit</h3>
                <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
                  ...
                  <a href="https://replit.com/privacy" className="text-blue-600 hover:text-blue-800 dark:text-blue-400 dark:hover:text-blue-300 ml-1">replit.com/privacy</a>
                </p>
              </div>
              <div>
                <h3 className="font-semibold text-gray-800 dark:text-gray-200 mb-2">8.2 Supabase</h3>
                <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
                  ...
                  <a href="https://supabase.com/privacy" className="text-blue-600 hover:text-blue-800 dark:text-blue-400 dark:hover:text-blue-300 ml-1">supabase.com/privacy</a>
                </p>
              </div>
            </div>
          ...
          <section>
            <h2 className="text-2xl font-semibold text-gray-800 dark:text-gray-200 mb-4">9. Cookies e Tecnologias Similares</h2>
            <p className="text-gray-600 dark:text-gray-300 leading-relaxed mb-4">
          ...
          <section>
            <h2 className="text-2xl font-semibold text-gray-800 dark:text-gray-200 mb-4">10. Transferências Internacionais</h2>
            <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
          ...
          <section>
            <h2 className="text-2xl font-semibold text-gray-800 dark:text-gray-200 mb-4">11. Menores de Idade</h2>
            <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
          ...
          <section>
            <h2 className="text-2xl font-semibold text-gray-800 dark:text-gray-200 mb-4">12. Alterações à Política</h2>
            <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
          ...
          <section>
            ...
            <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
              ...
              contacte-nos através do email: <a href="mailto:d2413175@gmail.com" className="text-blue-600 hover:text-blue-800 dark:text-blue-400 dark:hover:text-blue-300">contacto@jikulumessu.ao</a>
            </p>
          </section>
